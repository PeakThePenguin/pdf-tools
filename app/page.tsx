...
const TOOLS: Tool[] = [
  ...
  { href: '/watermark', icon: '💧', title: 'Add watermark to PDF', desc: 'Stamp a diagonal text watermark on every page.', color: '#7C3AED' },
  { href: '/watermark-image', icon: '💧', title: 'Add watermark to Image', desc: 'Stamp a diagonal text watermark on a JPG, PNG, or GIF.', color: '#7C3AED' },
